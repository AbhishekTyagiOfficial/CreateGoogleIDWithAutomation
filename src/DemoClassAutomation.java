...
//		create object
		...
		next_b.click();
		System.out.println("next_B Clicked wEIpqb nQOrEb");
		...
		custom_id.sendKeys("testingk1898");
		...
		WebElement custom_pass = driver.findElement(By.id("passwd"));
		custom_pass.sendKeys("Testingk1898");
		
		WebElement custom_confirm_pass = driver.findElement(By.id("confirm-passwd"));
		custom_confirm_pass.sendKeys("Testingk1898");
